...
# Can only access 10,000 runners at a time. Code will timeout and nothing
# will be saved if you try and scrape more than 10,000 runners at a time.
number = 1
year = 2010
start = int(f'{number - 1}0000')
end = int(f'{number}0000')
df = pd.read_csv(f'nyc-marathon-{year}-eventRunner.csv')
